<div class="slider">
	...
	<link href="<?= $this->theme->getBaseUrl().'/css/orbit.css'; ?>" rel="stylesheet">
	...
	<div class="panel panel-default members" id="share-panel">
		<div class="panel-body">
			...
			<div id="featured"> 
				<img src="<?= $this->theme->getBaseUrl().'/img/orbit/banner/1.jpg'; ?>" rel="caption-1" />
				<a href="http://humhub.com" target="_blank">
					<img src="<?= $this->theme->getBaseUrl().'/img/orbit/banner/2.jpg'; ?>" rel="caption-2" />
				</a>
				<img src="<?= $this->theme->getBaseUrl().'/img/orbit/banner/3.jpg'; ?>" rel="caption-3" />
				<img src="<?= $this->theme->getBaseUrl().'/img/orbit/banner/4.jpg'; ?>"  rel="caption-4" />
			</div>
	...
	<script src="<?= $this->theme->getBaseUrl().'/js/jquery.orbit.min.js'; ?>"></script>	
