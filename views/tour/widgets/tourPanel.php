...
<div class="panel panel-default panel-tour" id="getting-started-panel">
    ...
    <div class="panel-body">
        <p>
            <?= Yii::t('TourModule.widgets_views_tourPanel', 'Get to know your way around the site\'s most important features with the following guides:'); ?>
        </p>
        ...
        <ul class="tour-list">
            ...
            <li class="<?php if ($spaces == 1) : ?>completed<?php endif; ?>">
                <a id="interface-tour-link" href="<?= Url::to(['/tour/tour/start-space-tour']); ?>" data-pjax-prevent>
            ...
            <li class="<?php if ($profile == 1) : ?>completed<?php endif; ?>">
                <a href="<?= Yii::$app->user->getIdentity()->createUrl('//user/profile', array('tour' => 'true')); ?>" data-pjax-prevent>
            ...
            <?php if (Yii::$app->user->isAdmin() == true) : ?>
                <li class="<?php if ($administration == 1) : ?>completed<?php endif; ?>">
                    <a href="<?= Url::to(['/admin/module/list-online', 'tour' => 'true']); ?>" data-pjax-prevent>
